...
while (rs.next()) {
	categories += "<option value='" + rs.getString("category_name") + "'>" + rs.getString("category_name")
	+ "</option>";
}
try {
						...
						<div class="col-6 col-md-4 order-3 order-md-3 text-right">
							<div class="site-top-icons">
								...
								<ul>
									...
									<li><a
										href='${pageContext.request.contextPath}/invalidate?rd=index'
							...
							<div class="p-3 p-lg-5 border row justify-content-center">
								...
								<div class="col-md-10">
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label for="title" class="text-black">Name <span
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label for="c_price" class="text-black">Current Price
												<span class="text-danger">*</span>
											</label> <input type="number" class="form-control" id="c_price"
												name="c_price" placeholder="Current Price ($)">
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label for="r_price" class="text-black">Retail Price
												<span class="text-danger">*</span>
											</label> <input type="number" class="form-control" id="r_price"
												name="r_price" placeholder="Retail Price ($)">
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label for="stockQty" class="text-black">Stock
												Quantity <span class="text-danger">*</span>
											</label> <input type="number" class="form-control" id="stockQuantity"
												name="stockQuantity" placeholder="Quantity">
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label for="productCat" class="text-black">Product
												Category <span class="text-danger">*</span>
											</label><br> <select name="productCat">
												<%=categories%>
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											<label for="briefDesc" class="text-black">Brief
												Description: </label>
											<textarea name="briefDesc" id="briefDesc" cols="30" rows="5"
												class="form-control"
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											<label for="fullDesc" class="text-black">Full
												Description: </label>
											<textarea name="detailedDesc" id="fullDesc" cols="30"
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label for="ImagePath" class="text-black">Upload
												Image</label> <input type="file" name="file" id="imagefile"
												class="form-control" placeholder="Image Path">
											</textarea>
										</div>
								...
								<div class="form-group col-md-12 mb-5 d-flex flex-row-reverse">
									...
									<div class="col-lg-3 p-3">
										<input id="uploadProd" type="submit"
