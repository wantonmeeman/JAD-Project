...
public class userOrderDB {
	...
	public ArrayList<order> getAllOrders(String orderSort,String timeSort,String filterValue,String filterCategory) {//Tab3
		...
		if(filterValue == null || filterCategory == null || filterValue.equals("") || filterCategory.equals("") || filterCategory.equals("name") || filterCategory.equals("username") || filterCategory.equals("email") || filterCategory.equals("phonenumber")){
			filterSuffix = "";
		...
		while (rs.next()){
			...
			if(!(orderObj.getOrderProduct() == null || orderObj.getOrderUsername() == null || orderObj.getOrderEmail() == null || orderObj.getOrderPhoneNumber() == null)){
				orders.add(orderObj);
			}
		}
		return orders;
